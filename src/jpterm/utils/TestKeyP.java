 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class TestKeyP extends JFrame implements KeyListener {
    ...
    private DrawingArea drawA = new DrawingArea();
    
    public TestKeyP() {
        contentPane= (JPanel) this.getContentPane();
        contentPane.setLayout(borderLayout1);
        this.setSize(new Dimension(545, 560));
    ...
    public void keyPressed(KeyEvent e) {
		...
		//if (key != KeyEvent.VK_SHIFT && key != KeyEvent.VK_CONTROL &&
		     //key != KeyEvent.VK_ALT) {
			//System.out.println("Key: " + keyType(e));
			//int platoKey = PlatoCrap.platoKeypress(e);
			//System.out.println("Plato: " + platoKey);
		 //}
    }
    ...
    public void keyTyped(KeyEvent e) {
		//System.out.println("Key: " + keyType(e));
		//int platoKey = PlatoCrap.platoKeyType(e);
		//System.out.println("typed: " + platoKey);
    	//drawA.drawChar(cx,128,1,'A');
    	cx += 8;
    }

	private String keyType(KeyEvent e) {
		...
		switch (e.getID()) {
			   ...
			   case KeyEvent.KEY_PRESSED:
				   s.append("pressed ");
				   s.append(getKeyText(e.getKeyCode()) + " ");
				   break;
